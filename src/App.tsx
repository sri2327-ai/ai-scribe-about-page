...
const AlaskaTherapyCaseStudy = React.lazy(() => import('./pages/case-studies/AlaskaTherapyCaseStudy'));
    ...
    <BrowserRouter>
      ...
      <Suspense fallback={<SectionLoader />}>
        <Routes>
          ...
          <Route path="/case-studies/alaska-therapy" element={<AlaskaTherapyCaseStudy />} />
