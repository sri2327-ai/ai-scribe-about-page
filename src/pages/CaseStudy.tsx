...
const caseStudies = [
  ...
  { folder: "crush-saves-2-hours-daily-for-multi-provider-practices", title: "S10.AI Saves 2+ Hours Daily for Multi-Provider Practices", description: "S10.AI enhances workflow and saves over 2 hours daily for multi-provider practices by streamlining documentation.", useCustomIllustration: true, illustrationType: "multiProvider" },
  { folder: "crush-intake-q-transforming-dr-strotman-practice", title: "S10.AI & INTAKE Q: Transforming Dr. Strotman's Practice", description: "S10.AI integrates seamlessly with INTAKE Q to automate documentation, saving time and improving efficiency.", useCustomIllustration: true, illustrationType: "intakeQ" },
