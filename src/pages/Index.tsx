...
const Index = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-blue-950 to-black relative overflow-hidden">
      ...
      <div className="text-center max-w-3xl px-4 relative z-10 flex items-center justify-center min-h-screen">
        <div>
      ...
      <div className="absolute bottom-8 w-full flex justify-center space-x-4 z-10">
        <Link to="/advantages" className="bg-teal-500 hover:bg-teal-600 text-white font-bold py-2 px-4 rounded transition-all duration-300">
          View Advantages
        </Link>
      </div>
    </div>
