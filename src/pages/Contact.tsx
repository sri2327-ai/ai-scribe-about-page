      ...
      <div className="container mx-auto flex flex-col md:flex-row gap-8 items-start justify-center">
        ...
        <div className="w-full md:w-1/2 lg:w-2/5 flex flex-col gap-6">
          <Card className="p-6 shadow-lg rounded-xl bg-white/90 border border-gray-200">
            <h2 className="text-2xl font-semibold text-[#133255] mb-2">Schedule Your Free Demo</h2>
            <p className="text-gray-800 mb-3">
              See S10.AI’s <b>Bravo</b> & <b>Crush</b> in action – join 1,000+ providers saving time!
            </p>
            <p className="text-gray-800 mb-3">
              Our 15-minute virtual demo shows how <b>Bravo</b> automates scheduling and patient communication,
              and <b>Crush</b> delivers 99% accurate clinical notes, integrated with your EHR.<br />
              <span className="block">Tailored to your specialty, no commitment needed.</span>
            </p>
            <button
              className="mt-2 mb-3 px-6 py-2 w-full rounded-lg bg-[#387E89] text-white font-bold hover:bg-[#133255] transition"
              tabIndex={-1} // Does nothing for now, handled by the form on the left
              disabled
            >
              Schedule Demo
            </button>
            ...
            <div className="bg-[#E9F4FD] rounded-md p-3 text-xs text-[#133255] font-medium mb-2">
              HIPAA-compliant, ISO 27001-certified, trusted by 40,000+ providers.<br />
              Save 90% on charting with Crush and reduce no-shows with Bravo.
            </div>
          </Card>
