...
const Pricing = () => {
  ...
  return <main className="min-h-screen bg-white overflow-x-hidden">
      <Helmet>
      ...
      <WaveBackground intensity="medium" baseColor={crushAIColors.tertiary} height="calc(100vh - 80px)" className="flex items-center">
        <div className="container mx-auto px-4 text-center">
          ...
          duration: 0.8
            ...
            <Button size="lg" className="rounded-full px-4 md:px-8 py-4 md:py-5 text-base md:text-lg bg-gradient-to-r from-[#143151] to-[#387E89] hover:from-[#0d1f31] hover:to-[#2c6269] text-white shadow-xl transition-all duration-300 hover:scale-105" onClick={() => {
      ...
      <section id="pricing" className="py-12 md:py-16 lg:py-20 bg-gradient-to-b from-gray-50 to-white">
        <div className="container mx-auto px-4">
          ...
          once: true
            ...
            <motion.h2 variants={fadeInUpVariants} custom={0} className="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-[#143151]">
              Simple, Transparent Pricing
            </motion.h2>
            <motion.p variants={fadeInUpVariants} custom={1} className="text-base md:text-lg max-w-2xl mx-auto text-[#387E89]">
          ...
          {/* Tabs - Improved alignment and UX for desktop/laptop */}
          <div className="flex flex-col items-center">
            <Tabs value={activeTab} onValueChange={handleTabChange} className="w-full flex flex-col items-center">
              {/* Improved TabsList for better desktop/laptop alignment */}
              <TabsList className="mb-6 md:mb-8 grid grid-cols-3 w-full max-w-3xl gap-2 p-1.5 bg-gray-100/70 rounded-full">
                <TabsTrigger value="crush" className="px-4 py-2.5 text-sm md:text-base lg:text-lg font-medium whitespace-nowrap rounded-full transition-all">
                  {isMobile ? "CRUSH" : "CRUSH AI Scribe"}
                </TabsTrigger>
                <TabsTrigger value="bravo" className="px-4 py-2.5 text-sm md:text-base lg:text-lg font-medium whitespace-nowrap rounded-full transition-all">
                  {isMobile ? "BRAVO" : "BRAVO Staffing Agent"}
                </TabsTrigger>
                <TabsTrigger value="bundle" className="px-4 py-2.5 text-sm md:text-base lg:text-lg font-medium whitespace-nowrap rounded-full transition-all">
              ...
              <div className="flex justify-center mb-8 md:mb-12">
                <div className="flex bg-gray-100 rounded-full p-1">
                  <Button variant="ghost" onClick={() => handleBillingCycleChange('monthly')} className={`rounded-full text-xs md:text-sm px-3 py-1 ${billingCycle === 'monthly' ? 'bg-[#143151] text-white' : 'text-gray-700 hover:text-[#143151]'}`}>
                    Monthly
                  </Button>
                  <TooltipProvider>
                    <Tooltip>
                      <TooltipTrigger asChild>
                        <Button variant="ghost" onClick={() => handleBillingCycleChange('annual')} className={`rounded-full flex items-center text-xs md:text-sm px-3 py-1 ${billingCycle === 'annual' ? 'bg-[#143151] text-white' : 'text-gray-700 hover:text-[#143151]'}`}>
                          Annual
              ...
              <TabsContent value="crush" className="w-full">
                ...
                <PricingCards activePlan="crush" billingCycle={billingCycle} selectedCurrency={selectedCurrency} />
              </TabsContent>
              ...
              <TabsContent value="bravo" className="w-full">
                ...
                <PricingCards activePlan="bravo" billingCycle={billingCycle} selectedCurrency={selectedCurrency} />
              </TabsContent>
              ...
              <TabsContent value="bundle" className="w-full">
                ...
                <PricingCards activePlan="bundle" billingCycle={billingCycle} selectedCurrency={selectedCurrency} />
              </TabsContent>
            </Tabs>
          </div>
        </div>
      ...
      <section className="py-12 md:py-16 lg:py-24 bg-gray-50">
        <div className="container mx-auto px-4">
          ...
          once: true
            ...
            <motion.h2 variants={fadeInUpVariants} custom={0} className="text-2xl md:text-3xl lg:text-4xl xl:text-5xl font-bold mb-3 md:mb-5 text-[#143151]">
              Why CRUSH & BRAVO Are the Ultimate AI-Powered Solutions
            </motion.h2>
            <motion.p variants={fadeInUpVariants} custom={1} className="text-base md:text-lg lg:text-xl max-w-3xl mx-auto text-[#387E89]">
          ...
          <Tabs defaultValue="crush" className="w-full flex flex-col items-center">
            <TabsList className="mb-6 md:mb-10 flex w-full max-w-md justify-center p-1 bg-gradient-to-r from-gray-100 to-gray-200 rounded-full shadow-sm">
              <TabsTrigger value="crush" className="flex-1 px-4 py-2 text-xs sm:text-sm md:text-base font-medium transition-all">
                CRUSH Features
              </TabsTrigger>
              <TabsTrigger value="bravo" className="flex-1 px-4 py-2 text-xs sm:text-sm md:text-base font-medium transition-all">
                BRAVO Features
              </TabsTrigger>
            </TabsList>
      ...
      {/* Why Choose */}
      <GradientSection intensity="light" variant="radial" sx={{
      py: {
        xs: 8,
        md: 16
      }
        ...
        <div className="container mx-auto px-4">
          ...
          once: true
            ...
            <motion.h2 variants={fadeInUpVariants} custom={0} className="text-2xl md:text-3xl lg:text-4xl font-bold mb-3 md:mb-4 text-slate-950">
              Why Clinicians Trust CRUSH & BRAVO
            </motion.h2>
            <motion.p variants={fadeInUpVariants} custom={1} className="text-base md:text-lg max-w-3xl mx-auto text-zinc-950">
              Ditch outdated tools. Our HIPAA-compliant, AI-powered solutions are built for clinicians.
            </motion.p>
          </motion.div>

          <div className="grid md:grid-cols-3 gap-6 md:gap-8 max-w-5xl mx-auto">
            <motion.div variants={fadeInUpVariants} custom={2} initial="hidden" whileInView="visible" viewport={{
            once: true
          }} className="bg-white p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 flex flex-col items-center text-center" whileHover={{
            y: -5
          }}>
            ...
            <motion.div variants={fadeInUpVariants} custom={3} initial="hidden" whileInView="visible" viewport={{
            once: true
          }} className="bg-white p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 flex flex-col items-center text-center" whileHover={{
            y: -5
          }}>
            ...
            <motion.div variants={fadeInUpVariants} custom={4} initial="hidden" whileInView="visible" viewport={{
            once: true
          }} className="bg-white p-6 md:p-8 rounded-2xl shadow-lg hover:shadow-xl transition-all duration-300 border border-gray-100 flex flex-col items-center text-center" whileHover={{
            y: -5
          }}>
      ...
      <section className="py-12 md:py-16 lg:py-20 bg-white">
        <div className="container mx-auto px-4">
          ...
          once: true
            ...
            <motion.p variants={fadeInUpVariants} custom={1} className="text-base md:text-lg max-w-3xl mx-auto text-[#387E89]">
          ...
          once: true
            ...
            {['HIPAA', 'SOC 2', 'HITECH', 'GDPR', 'ISO 27001', 'HITRUST', 'PHIPA'].map((badge, index) => <Badge key={index} className="text-sm md:text-base font-medium py-1 md:py-2 px-3 md:px-4 bg-gradient-to-r from-[#143151] to-[#387E89] hover:bg-gradient-to-r hover:from-[#0e2238] hover:to-[#2c6269] text-white border-none shadow-sm">
                {badge}
              </Badge>)}
          </motion.div>
        </div>
      ...
      <section className="py-12 md:py-16 lg:py-20 bg-gradient-to-r from-[#143151] to-[#387E89] text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          once: true
            ...
            <motion.h2 variants={fadeInUpVariants} custom={0} className="text-2xl md:text-3xl lg:text-4xl font-bold mb-4 md:mb-6">
              Ready to Revolutionize Your Practice?
            </motion.h2>
            <motion.p variants={fadeInUpVariants} custom={1} className="text-base md:text-lg mb-6 md:mb-8 max-w-3xl mx-auto">
            ...
            <motion.div variants={fadeInUpVariants} custom={2}>
              <Button size="lg" className="rounded-full px-4 md:px-8 py-4 md:py-6 text-base md:text-lg bg-white text-[#143151] hover:bg-gray-100 shadow-lg transition-all duration-300 hover:scale-105">
