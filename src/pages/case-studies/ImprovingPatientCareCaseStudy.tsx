...
export default function ImprovingPatientCareCaseStudy() {
  return (
    <CaseStudyLayout
      title="Improving Patient Care With S10.AI AI Medical Scribe"
    ...
    >
      <div className="space-y-8">
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4">Challenges Faced by Physicians</h2>
          ...
          <p className="mt-4">These challenges collectively contribute to the burden faced by physicians, reducing their ability to provide optimal patient care and negatively impacting their well-being. Addressing these challenges is crucial for improving patient care and physician satisfaction in the healthcare industry.</p>
        </section>

        <section>
          <h2 className="text-2xl font-bold mb-4">Intervention with S10.AI AI Medical Scribe</h2>
          ...
          <p className="mt-4">The intervention with S10.AI AI Medical Scribe can be implemented in the following ways:</p>
        ...
        <section>
          <h2 className="text-2xl font-bold mb-4">Enhanced Patient Care through Accurate Documentation with S10.AI AI Medical Scribe</h2>
          <p>S10.AI AI Medical Scribe can improve patient care in several ways:</p>
