...
export default function RevolutionizingBanner() {
  return (
      ...
      <div className={styles.casestudycontainer}>  
        <div className={styles.bannerCard}>
          <div className={styles.bannerContent}>
            ...
            {/* Title & Description */}
            <Typography variant="h2">Revolutionizing Functional Medicine with CRUSH</Typography>
            <p>CRUSH streamlines documentation in functional and longevity medicine, enhancing patient care and practice efficiency.</p>
