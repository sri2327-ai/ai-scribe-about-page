...
export default function CrushIntakeBanner() {
  return (
      ...
      <div className={styles.casestudycontainer}>  
        <div className={styles.bannerCard}>
          <div className={styles.bannerContent}>
            ...
            {/* Title & Description */}
            <Typography variant="h2">CRUSH & INTAKE Q: Transforming Dr. Strotman’s Practice</Typography>
            <p>CRUSH integrates seamlessly with INTAKE Q to automate patient intake and documentation, saving time and improving efficiency.</p>
