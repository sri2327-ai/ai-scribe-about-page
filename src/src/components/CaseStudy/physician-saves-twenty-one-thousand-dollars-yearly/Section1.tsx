...
export default function TwentyoneThousandBanner() {
  return (
      ...
      <div className={styles.casestudycontainer}>  
        <div className={styles.bannerCard}>
          <div className={styles.bannerContent}>
            ...
            {/* Title & Description */}
            <Typography variant="h2">Physician saves $21,144 yearly</Typography>
            <p>Cut costs by replacing traditional scribes with Crush AI Medical Scribe.</p>
