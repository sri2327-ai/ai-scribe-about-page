...
export default function SeventeenThousandBanner() {
  return (
      ...
      <div className={styles.casestudycontainer}>  
        <div className={styles.bannerCard}>
          <div className={styles.bannerContent}>
            ...
            {/* Title & Description */}
            <Typography variant="h2">Physician saves $17,796 yearly</Typography>
            <p>Eliminate transcription costs with Crush S10.AI Medical Scribe.</p>
