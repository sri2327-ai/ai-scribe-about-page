  ...
  return (
    ...
    >
        ...
        <div className="relative px-2 sm:px-4">
          ...
          <div className="absolute inset-0 pointer-events-none -z-10">
            <div className="absolute top-1/2 left-1/2 w-full h-full -translate-x-1/2 -translate-y-1/2">
              <div className="w-full h-full opacity-20 bg-gradient-radial from-blue-200 to-transparent" />
              <motion.div 
              ...
              >
                <div className="w-full h-full bg-gradient-radial from-blue-300/20 via-transparent to-transparent" />
              </motion.div>
            </div>
          </div>
        </div>
      ...
      {!isMobile && (
        <>
          <motion.div 
            className="absolute top-20 left-0 w-24 h-24 rounded-full bg-blue-100/30 blur-2xl -z-10"
            animate={{
              x: [0, 20, 0],
              opacity: [0.3, 0.5, 0.3]
            }}
          ...
          />
          <motion.div 
            className="absolute bottom-20 right-10 w-32 h-32 rounded-full bg-teal-100/20 blur-2xl -z-10"
            animate={{
              x: [0, -30, 0],
              opacity: [0.2, 0.4, 0.2]
            }}
