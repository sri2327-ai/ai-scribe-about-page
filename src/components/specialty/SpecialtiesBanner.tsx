  ...
  return (
    <section className="w-full bg-white pt-4 md:pt-10">
      <div className={typography.spacing.container}>
        <div className="flex flex-col md:flex-row items-center gap-4 md:gap-10 py-4 md:py-10">
          <motion.div 
          ...
          >
            <h1 className={withTypography(typography.h1, "text-[#143151] leading-tight")}>
              Transforming Healthcare,<br className="hidden sm:block" />
              One Specialty at a Time
            </h1>
            
            <p className={withTypography(typography.description, "max-w-xl")}>
