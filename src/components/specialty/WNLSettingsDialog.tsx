  ...
  return (
    <Dialog>
      ...
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          <DialogTitle>Within Normal Limits (WNL) Settings</DialogTitle>
        </DialogHeader>
        <div className="space-y-4 pt-4">
          <div className="space-y-2">
            <h4 className="font-medium">If a topic is not addressed:</h4>
            <div className="pl-4 space-y-2">
              <Button variant="ghost" className="w-full justify-start" onClick={handleOptionClick}>
          ...
          <div className="space-y-2">
            <h4 className="font-medium">If findings are normal:</h4>
            <div className="pl-4 space-y-2">
              <Button variant="ghost" className="w-full justify-start" onClick={handleOptionClick}>
