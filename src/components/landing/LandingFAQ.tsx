    ...
    <section className="py-16 md:py-24 bg-gradient-to-br from-gray-50 via-white to-blue-50 relative overflow-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-4xl relative">
        ...
        >
            ...
            {landingFAQs.map((faq, index) => (
              <motion.div key={faq.id} variants={itemVariants}>
                <AccordionItem 
                  value={faq.id}
                  className={cn(
                    "border border-gray-200 rounded-2xl bg-white/80 backdrop-blur-sm overflow-hidden",
                    "hover:shadow-lg hover:border-blue-200 transition-all duration-300",
                    "group data-[state=open]:shadow-xl data-[state=open]:border-blue-300 data-[state=open]:bg-white"
                  )}
                >
                  <AccordionTrigger className="px-6 py-6 hover:no-underline group">
                    <div className="flex items-center gap-4 w-full text-left">
                      <div className={cn(
                        ...
                        "group-data-[state=open]:from-blue-500 group-data-[state=open]:to-purple-500 group-data-[state=open]:text-white",
          ...
          >
            <Card className="p-8 md:p-10 bg-gradient-to-br from-blue-600 to-purple-600 border-0 text-white relative overflow-hidden">
              {/* Background pattern */}
              ...
              <div className="relative">
                ...
                <h3 className="text-2xl md:text-3xl font-bold mb-4">
                  Let's discuss how S10.AI can transform your practice
                </h3>
                
                <p className="text-blue-100 mb-8 text-lg max-w-2xl mx-auto">
                  Our healthcare AI experts are ready to answer your specific questions and show you exactly how S10.AI works in your environment.
                </p>
                
                <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
                  <Button 
                    size="lg"
                    className="bg-white text-blue-600 hover:bg-gray-50 px-8 py-3 font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 group"
                  ...
                  <Button 
                    size="lg"
                    variant="ghost"
                    className="text-white border-2 border-white/30 hover:bg-white/10 px-8 py-3 font-semibold rounded-xl transition-all duration-300"
