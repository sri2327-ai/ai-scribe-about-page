          ...
          delay: 0.1
            ...
            <div className="space-y-4 lg:space-y-6">
              ...
              color: '#1a1a1a'
                ...
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#143151] via-[#387E89] to-[#143151]">The AI That</span>
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#387E89] via-[#5192AE] to-[#387E89]">Charts &amp;</span>
                <span className="block text-gray-800">Staffs - So You</span>
                <span className="block text-transparent bg-clip-text bg-gradient-to-r from-[#143151] via-[#387E89] to-[#5192AE]">Don't Have To</span>
              </motion.h1>
              ...
              <div className="p-6">
                <div className="bg-gradient-to-br from-blue-50/50 via-white to-teal-50/50 rounded-xl p-6 border border-blue-100/50 shadow-inner">
                  <div className="space-y-4">
                    ...
                    delay: 0.8 + index * 0.1
                  }} onClick={() => handleTabClick(index)} className={`group relative cursor-pointer rounded-xl p-4 transition-all duration-300 ${activeTabIndex === index ? 'bg-white shadow-lg ring-2 ring-[#387E89]/20 scale-[1.02]' : 'bg-white/60 hover:bg-white/90 hover:shadow-md'}`}>
                        <div className="flex items-start gap-3">
                          <div className={`w-12 h-12 rounded-xl flex items-center justify-center shrink-0 transition-all duration-300 ${activeTabIndex === index ? 'shadow-lg' : 'group-hover:shadow-md'}`} style={{
                        background: activeTabIndex === index ? `linear-gradient(135deg, ${tab.color}15, ${tab.color}25)` : `${tab.color}10`
                          ...
                          <div className="flex-1 min-w-0">
                            <h4 className={`font-semibold text-sm mb-2 ${activeTabIndex === index ? 'text-gray-900' : 'text-gray-700'}`}>
                              {tab.title}
                            </h4>
                  ...
                  <div className="flex justify-center gap-2 mt-6">
                    {featureTabs.map((_, idx) => <button key={idx} onClick={() => handleTabClick(idx)} className={`transition-all duration-300 rounded-full ${activeTabIndex === idx ? 'w-8 h-3 bg-gradient-to-r from-[#387E89] to-[#143151]' : 'w-3 h-3 bg-gray-300 hover:bg-gray-400'}`} />)}
                  </div>
                </div>
              </div>
            </Card>
