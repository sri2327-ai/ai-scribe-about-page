...
export const FirstSection = () => {
  ...
  return <section className="min-h-screen bg-white overflow-hidden">
              ...
              mx: {
                ...
                gap: {
                  ...
                  <Box>
                    ...
                    lineHeight: 1.7,
                    fontWeight: 400
                  }} className="">Don’t adapt to your AI—make it work for you.

S10.AI’s AI medical scribe and patient engagement agent integrate seamlessly with Epic, Cerner, your preferred EHR, and 7,000+ other apps. Trusted by over 1,000 clinics worldwide, S10.AI helps you customize workflows to save time, stay HIPAA-compliant, and see results in days: 30% faster charting and over 20% higher patient satisfaction.</Typography>
                  </Box>
                  <Box sx={{
                  display: 'flex',
                  justifyContent: 'center',
