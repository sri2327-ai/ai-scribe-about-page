...
const TestimonialCard = ({
  ...
  flex: '1 1 0'
    ...
    <CardMedia component="img" image={data.docImg} alt={data.docImgAlt} sx={{
    width: "100%",
    height: {
      xs: "180px",
      sm: "220px",
  ...
  return <section className="py-10 px-2 md:px-8 lg:px-16 bg-white overflow-hidden">
      ...
      <Box sx={{
        ...
        overflow: 'hidden'
          ...
          maxWidth: '420px'
              ...
              {docRevData.map((value, index) => <Box key={index} sx={{
            px: {
              xs: 1,
              md: 2
            }
      ...
      <Box sx={{
        ...
        flexWrap: 'nowrap'
            ...
            {docRevData.map((value, index) => <TestimonialCard key={index} data={value} />)}
          </Box>}
      </Box>
    </section>;
};
