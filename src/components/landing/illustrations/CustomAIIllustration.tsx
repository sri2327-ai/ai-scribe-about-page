...
import { Cog, Zap, Brain, Settings, Workflow } from 'lucide-react';

const steps = [
  { Icon: Brain, label: "AI Analysis", delay: 0 },
  { Icon: Settings, label: "Custom Config", delay: 1 },
  { Icon: Workflow, label: "Workflow Design", delay: 2 },
  { Icon: Cog, label: "Agent Deployment", delay: 3 },
  { Icon: Zap, label: "Smart Automation", delay: 4 }
];
