  ...
  return (
    <section className="bg-black py-16 md:py-24 px-4 sm:px-6">
      <div className="container mx-auto flex flex-col items-center justify-center">
        ...
        >
          <CommitsGrid 
            ...
            colorScheme={{
              ...
              activeBg: "bg-[#48d55d]", // This class is needed but the actual colors are now handled dynamically
        ...
        <motion.p 
          className="text-center mt-8 text-xl md:text-2xl font-normal text-gray-500" 
