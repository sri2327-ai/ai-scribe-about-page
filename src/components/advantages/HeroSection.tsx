      ...
      >
        ...
        >
          ...
          <RainbowButton 
            ...
            className="rounded-full px-6 py-3 w-auto max-w-fit flex items-center justify-center gap-2 border-2 border-white/50 hover:border-white/70 transition-all duration-300"
          >
