...
export const FinalCTA: React.FC = () => {
  ...
  const roiStats = [
    {
      icon: <Clock className="h-5 w-5 mb-1 text-teal-500" />,
      value: "75%",
      label: "Less documentation time"
    },
    {
      icon: <DollarSign className="h-5 w-5 mb-1 text-teal-500" />,
      value: "40%",
      label: "Increased revenue"
    },
    {
      icon: <Heart className="h-5 w-5 mb-1 text-teal-500" />,
      value: "95%",
      label: "Patient satisfaction"
    },
    {
      icon: <TrendingUp className="h-5 w-5 mb-1 text-teal-500" />,
      value: "$150K+",
      label: "Annual savings"
    },
    {
      icon: <Users className="h-5 w-5 mb-1 text-teal-500" />,
      value: "30%",
      label: "More patients"
    }
  ];
