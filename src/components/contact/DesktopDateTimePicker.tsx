...
const DesktopDateTimePicker = ({
  ...
  return (
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent 
        className="max-w-4xl h-[85vh] bg-gradient-to-b from-white to-gray-50 overflow-hidden p-0 flex flex-col"
      ...
      >
        ...
        <DialogHeader className="px-6 pt-6 pb-4 pr-16 bg-white border-b border-gray-100 flex-shrink-0">
          <div className="flex items-center justify-between mb-4">
            <DialogTitle className="text-2xl font-bold text-[#133255]">Schedule Demo</DialogTitle>
        ...
        {/* Bottom Navigation */}
        <div className="px-6 pb-6 bg-white border-t border-gray-100 flex-shrink-0">
          {currentStep !== 'confirm' ? (
