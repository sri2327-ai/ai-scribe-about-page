...
export function BeamsBackground({
    ...
    useEffect(() => {
        ...
        function drawBeam(ctx: CanvasRenderingContext2D, beam: Beam) {
            ...
            gradient.addColorStop(0.1, `rgba(235, 107, 145, ${pulsingOpacity * 0.5})`);
            gradient.addColorStop(0.4, `rgba(235, 107, 145, ${pulsingOpacity})`);
            gradient.addColorStop(0.6, `rgba(14, 165, 233, ${pulsingOpacity})`);
            gradient.addColorStop(0.9, `rgba(14, 165, 233, ${pulsingOpacity * 0.5})`);
            gradient.addColorStop(1, `rgba(255, 255, 255, 0)`);
    ...
    return (
        <div
            ...
            style={{
                background: "radial-gradient(circle at center, #046f90 0%, #0d252b 100%)",
            }}
        >
            <canvas
                ref={canvasRef}
