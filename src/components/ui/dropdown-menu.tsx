...
// Update interface to explicitly include children
...
// Update interface to explicitly include children and checked
...
// Update interface to explicitly include className
