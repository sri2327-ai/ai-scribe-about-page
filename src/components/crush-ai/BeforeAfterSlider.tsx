          ...
          >
            ...
            >
              <div className="absolute inset-0 flex items-stretch">
                ...
                >
                  <div className="absolute inset-0 bg-center bg-no-repeat bg-cover opacity-5"></div>
                  
                  {/* Add Badge for Without CRUSH - hidden */}
                  <div className="absolute top-6 left-6 z-20 opacity-0">
                  ...
                  <div className="z-10 max-w-md p-8">
                    ...
                    <h2 className={`${isMobile ? 'text-2xl' : 'text-4xl'} font-bold mb-4 text-gray-800`}>The old way of documentation</h2>
                ...
                >
                  ...
                  {/* Add Badge for With CRUSH - hidden */}
                  <div className="absolute top-6 left-6 z-20 opacity-0">
              ...
              <motion.div 
                className={cn(
                  "absolute top-0 bottom-0 w-1 bg-black/30 z-20",
              ...
              <div className="absolute bottom-6 left-0 right-0 flex justify-between px-8 z-30">
                <div className={`flex items-center gap-2 ${sliderPosition < 20 ? 'opacity-0' : 'opacity-100'} transition-opacity duration-300`}>
                  ...
                  <span className={`${isMobile ? 'text-xs' : 'text-sm'} text-black font-medium`}>Without CRUSH</span>
                </div>
            ...
            {/* Bottom labels - these should be visible */}
