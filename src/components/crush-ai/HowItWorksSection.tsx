      ...
      cursor: active ? 'pointer' : 'default'
        ...
        position: 'relative'
          ...
          alignItems: 'center'
            ...
            {active ? <Box>
                <AnimatePresence>
                  {['S:', 'O:', 'A:', 'P:'].map((section, i) => <motion.div key={section} initial={{
              opacity: 0,
              x: -5
            }} animate={{
              opacity: 1,
      ...
      <Container maxWidth="lg">
        ...
        zIndex: 1
          ...
          gap: 2
            ...
            return <Box key={index} component={motion.div} initial={{
              opacity: 0.8,
              x: -10
            }} animate={{
              ...
              duration: 0.2
            }} onClick={() => setActiveStep(index)} sx={{
              p: 2,
              borderRadius: 2,
              border: '1px solid',
              ...
              transition: 'all 0.3s ease'
                  ...
                  <Box component={motion.div} animate={isActive ? {
                ...
                border: isActive && !isCompleted ? '1px solid rgba(56,126,137, 0.3)' : 'none'
                    ...
                    {isCompleted ? <CheckCircle size={20} className="text-white" /> : <Typography sx={{
                  fontWeight: 600,
                  ...
                  {isActive && <Box component={motion.div} initial={{
                scale: 0
              }} animate={{
                scale: 1
              }} sx={{
          ...
          overflow: 'hidden'
              ...
              width: '100%'
                ...
                gap: 4
                  ...
                  position: 'relative'
                    ...
                    <Box component={motion.span} initial={{
                    width: 0
                  }} animate={{
                    width: '50%'
                  }} transition={{
                  ...
                  <AnimatePresence>
                    {steps[activeStep].details && <motion.div initial={{
                    opacity: 0,
                    height: 0
                  }} animate={{
                    opacity: 1,
                    ...
                    overflow: 'hidden'
                      ...
                      mt: 2
                          ...
                          {steps[activeStep].details.map((detail, i) => <motion.div key={i} initial={{
                        opacity: 0,
                        x: -10
                      }} animate={{
                        opacity: 1,
            ...
            justifyContent: 'center'
              ...
              <Button component={motion.button} whileHover={{
              scale: 1.05
            }} whileTap={{
              scale: 0.95
            }} variant="outlined" onClick={handleNextStep} sx={{
              ...
              '&:hover': {
                ...
                <motion.span className="absolute inset-0 bg-[#387E89]/10" initial={{
                x: '-100%'
              }} whileHover={{
                x: '100%'
              }} transition={{
        ...
        zIndex: 1
          ...
          <ShadcnButton size="lg" className="text-white rounded-full px-8 py-6 text-lg shadow-lg relative overflow-hidden group" style={{
          background: `linear-gradient(90deg, #143151, #387E89)`
        }}>
            <motion.span className="absolute inset-0 bg-white/10" initial={{
            x: '-100%'
          }} whileHover={{
            x: '100%'
          }} transition={{
