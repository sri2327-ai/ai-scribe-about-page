...
import PEGHeader from "../practice-efficiency-grader/PEGHeader";
...
const LoadingSpinner = () => (
  <div className="flex flex-col items-center justify-center py-8">
    <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-[#387E89] mb-4"></div>
    <Typography variant="h6" sx={{ color: crushAIColors.text.primary, fontSize: { xs: "1rem", md: "1.25rem" } }}>
        ...
        >
          ...
          >
            ...
            >
                ...
                <div className="border border-black/10 rounded-xl p-4 md:p-5 shadow-sm bg-white h-full flex flex-col">
                  ...
                  {isCalculating ? (
                    ...
                    <>
                      ...
                      >
                        * Calculation assumes an average cost of $2,000/month for a human medical scribe
                      </Typography>
                      
                      <Button 
                        className="w-full mt-4 rounded-md py-2.5 text-white"
                        style={{ 
              ...
              <div className="flex flex-col gap-4 p-4 md:p-5 border border-black/10 rounded-xl shadow-sm bg-white h-full md:order-1 order-1">
                <Typography 
                  variant="h5" 
                  sx={{ 
                    fontWeight: 600,
                ...
                <Stack spacing={2.5}>
                  <Box>
                    <Typography variant="body2" sx={{ mb: 1, color: crushAIColors.text.primary, fontWeight: 500 }}>
                  ...
                  <Box>
                    <Typography variant="body2" sx={{ mb: 1, color: crushAIColors.text.primary, fontWeight: 500 }}>
                      3. Patients per Day per Provider
                    </Typography>
                    <TextField
                      type="number"
                ...
                <div className="flex justify-center mt-4">
                  ...
                  >
                    ...
                    <span className="relative w-full flex items-center justify-center gap-2">
                      ...
                      />
                      {isCalculating ? "Calculating..." : isAttracting ? "Magnetizing Savings" : "Magnetize Savings"}
                    </span>
                  </Button>
                </div>
              </div>
