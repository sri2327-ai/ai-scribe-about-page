...
const PromoBanner = () => {
  return (
    <section className="py-8 md:py-12 px-4 md:px-8 bg-white">
      <Box className={cn("mx-auto rounded-2xl bg-gradient-to-r from-[#143151] to-[#387E89] p-6 md:p-12 text-center", shadowStyles.prominent)}>
        <Typography 
          variant="h3" 
        ...
        <button className={cn(
          "inline-flex items-center gap-2 rounded-full px-5 py-2.5 md:px-6 md:py-3 text-base md:text-lg bg-white text-[#143151] hover:bg-gray-100 transition-all duration-300 font-semibold hover:scale-105",
          shadowStyles.subtle
        )}>
          Book A Demo
