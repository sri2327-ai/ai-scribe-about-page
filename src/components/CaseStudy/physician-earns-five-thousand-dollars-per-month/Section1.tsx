...
export default function FiveThousandBanner() {
  return (
      ...
      <div className={styles.casestudycontainer}>  
        <div className={styles.bannerCard}>
          <div className={styles.bannerContent}>
            ...
            {/* Title & Description */}
            <Typography variant="h2">Physician Earns $5,311 Per Month More with Crush AI Medical Scribe</Typography>
            <p>Boost revenue with efficient and accurate AI scribing.</p>
