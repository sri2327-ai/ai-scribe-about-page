...
export default function ImprovingPatinetCareBanner() {
  return (
      ...
      <div className={styles.casestudycontainer}>  
        <div className={styles.bannerCard}>
          <div className={styles.bannerContent}>
            ...
            {/* Title & Description */}
            <Typography variant="h2">Improving Patient Care With S10.AI AI Medical Scribe</Typography>
            <p>Focus more on patients, less on paperwork with AI assistance.</p>
