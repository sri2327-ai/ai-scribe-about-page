...
const FeatureCard = ({ icon, title, description, index }: FeatureCardProps) => {
  ...
  return (
    <div 
      ref={cardRef}
      className={cn(
        "bg-white rounded-2xl shadow-lg opacity-0 p-4 sm:p-6 border border-gray-100",
    ...
    <section className="py-12 sm:py-16 md:py-20 pb-0 relative bg-gray-50" id="features" ref={sectionRef}>
      <div className="container px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-10 sm:mb-16">
          <div className="inline-flex items-center px-4 py-2 rounded-full bg-primary/10 text-primary mx-auto mb-3 sm:mb-4 opacity-0 fade-in-element">
            <span>Core Features</span>
          </div>
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4 opacity-0 fade-in-element text-gray-900">
            Advanced Intelligence, <br className="hidden sm:block" />Healthcare-Focused Innovation
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto opacity-0 fade-in-element">
            Built with cutting-edge AI technology designed specifically for healthcare workflows and clinical decision support.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Our AI continuously learns from clinical interactions, improving accuracy and adapting to your specific practice patterns and preferences."
            index={0}
          />
          <FeatureCard
            ...
            title="Natural Documentation"
            description="Communicate using natural language during patient encounters. S10.AI understands medical context and generates accurate clinical notes."
            index={1}
          />
          <FeatureCard
            ...
            description="Advanced EHR integration provides fluid connectivity with your existing healthcare systems and clinical workflows."
            index={2}
          />
          <FeatureCard
            ...
            description="Advanced clinical decision support and diagnostic assistance help improve patient outcomes and reduce medical errors."
            index={3}
          />
          <FeatureCard
            ...
            description="Built-in security protocols protect patient data and ensure full HIPAA compliance with enterprise-grade encryption."
            index={4}
          />
          <FeatureCard
            ...
            description="From appointment scheduling to follow-up reminders, S10.AI automates routine tasks to improve practice efficiency."
            index={5}
          />
        </div>
      </div>
