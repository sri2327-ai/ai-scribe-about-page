      ...
      <div className="container px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
        <div className="text-center mb-10 sm:mb-16">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-bold mb-3 sm:mb-4 opacity-0 fade-in-element text-gray-900">
            Stop Patching Problems. <br className="hidden sm:block" />Start Solving Them.
          </h2>
          <p className="text-lg text-gray-600 max-w-3xl mx-auto opacity-0 fade-in-element">
            You can buy an AI scribe and still have a chaotic front office. You can automate scheduling and still have clinician burnout. Point solutions create silos. S10.ai provides a complete workflow transformation by fixing both sides of the equation.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
          <FeatureCard
            ...
            description="Reclaim over 2 hours every day. Eliminate 'pajama time' spent charting at home with our AI Medical Scribe, CRUSH."
            index={0}
          />
          <FeatureCard
          ...
          <FeatureCard
            ...
            description="By removing the primary driver of burnout, we help you and your team get back to the joy of practicing medicine."
            index={4}
          />
          <FeatureCard
            ...
            description="Accelerate your revenue cycle with automated coding and real-time claim processing. Practices see revenue increase by up to 40%."
            index={5}
          />
        </div>
      </div>
