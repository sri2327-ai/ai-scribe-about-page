...
const benefits = [{
  ...
  description: 'HIPAA compliant with SOC 2 certification'
}, {
  icon: Globe,
  title: 'Universal Access',
  description: 'No downloads—works on any device instantly'
}, {
  icon: Calendar,
  title: 'Smart Scheduling',
  description: 'AI-powered reminders reduce no-shows by 40%'
}, {
  icon: Layers,
  title: 'S10.AI Integration',
  description: 'Seamless connection with CRUSH and BRAVO'
}];
const stats = [{
  value: 'HIPAA',
  label: 'Compliant'
