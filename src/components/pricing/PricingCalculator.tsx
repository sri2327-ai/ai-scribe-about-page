      ...
      <div className="grid grid-cols-1 md:grid-cols-5 gap-8">
            ...
            <div className="flex flex-wrap gap-6 justify-center md:justify-between">
              <div className="w-full md:w-auto">
                <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                  ...
                  <span className="text-xs text-gray-500">(How many clinicians are in your practice?)</span>
                </label>
                <input 
                  type="number" 
                  value={providers} 
              ...
              <div className="w-full md:w-auto">
                <label className="block text-sm font-medium text-gray-700 mb-2 flex items-center">
                  ...
                  <span className="text-xs text-gray-500">(How many patients does each provider see on average per day?)</span>
                </label>
                <input 
                  type="number" 
                  value={patients}
        ...
        <div className="md:col-span-2 bg-gray-50 rounded-xl p-4">
          ...
          <p className="text-gray-700 mb-4">
            A solo provider seeing 20 patients per day could save over 
            <span className="font-bold text-[#387E89]"> $2,900 per month </span> 
            compared to hiring a human scribe or staff—and reclaim 
            <span className="font-bold text-[#387E89]"> 10+ hours per week </span>
            for seeing more patients or enjoying personal time.
          </p>
