...
export default function FirstScl(...args: []) {
  ...
  return(
    <section className="witOutSp" style={{ background: `linear-gradient(135deg, ${theme.palette.common.white}, ${theme.palette.primary.light})` }}>
      <Box sx={{ display: 'flex', flexDirection:'column', justifyContent:'space-between', flexGrow: 1, gap: 3 }}>
        ...
        >
          ...
          >
            ...
            <Typography variant="h6">From AI medical scribes to patient care AI agents, CRUSH and BRAVO are AI-powered solutions that streamline clinical documentation, minimize administrative burdens, reduce burnout, and save you time—so you can focus on patient care and enhance healthcare automation.</Typography>
          </MotionPaper>
        </Stack>
        <Stack
          spacing={3}
          ...
          >
            ...
            <Box
              sx={{
                ...
                borderTop: `15px solid ${theme.palette.common.white}`
              }}
            />
          </MotionPaper>
          <Typography variant="h6" fontWeight="medium" sx={{ maxWidth: {xs : '150px', sm : '250px' } }}>S10.AI Is Recommended by</Typography>
