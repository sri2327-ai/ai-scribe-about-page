...
export default function FirstSection() {
  ...
  return (
    <section className="py-12 px-4 md:py-16 bg-gradient-to-br from-white to-blue-100">
      <div className="max-w-7xl mx-auto flex flex-col gap-8">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          >
            <div className="float-right bg-white flex items-center rounded-xl ml-4 p-2">
              <img
                src="/circleIcon.png"
                alt="circleIcon"
                width="90"
        ...
        <motion.div
          ...
          className="flex flex-wrap bg-gray-100 p-6 rounded-2xl rounded-tl-[40px] items-start"
        >
          <div className="relative flex bg-white -mt-2 -ml-2 p-4 rounded-br-[40px] rounded-tl-[40px]">
            <button className="bg-tealBlue hover:bg-tealBlueBright text-white px-6 py-3 rounded-full flex items-center gap-2 transition-all duration-300 shadow">
              <span className="flex items-center justify-center w-7 h-7 rounded-full border-2 border-white transition-all duration-300 hover:rotate-[-270deg]">
