  ...
  return (
    <section className={`${isMobile ? 'py-12' : 'py-20'} bg-gradient-to-br from-blue-950/30 via-indigo-950/20 to-purple-950/20`}>
      <div className="container mx-auto px-4">
        ...
        >
          <h2 className="text-3xl md:text-5xl font-bold mb-6 bg-clip-text text-transparent bg-gradient-to-r from-blue-400 to-purple-400">System Architecture</h2>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          >
            <h3 className="text-xl text-blue-300 font-semibold mb-4">Frontend Layer</h3>
          ...
          >
            <h3 className="text-xl text-indigo-300 font-semibold mb-4">AI Processing Layer</h3>
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-start">
          ...
          >
            <h3 className="text-xl text-purple-300 font-semibold mb-4">Backend Infrastructure</h3>
            <ul className="space-y-3 text-gray-300">
              <li className="flex items-start">
